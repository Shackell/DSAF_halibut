...
* Centriods for Region1 have been moved west into 4XW and Region 2 from the states in to Newfoundland 
* Range Edge was the only indicator without a regional componenet so it is unaffected, the rest have new "manipulated" versions (_manipulated.csv)
* I said I was going to reverse the distance to border values for Region 2, but didn't because they still reflect the right directional trend (thought the values are not accurate, should do as a placeholder)
...
POC_Abundance<-read.csv(here::here("Data/Data_SHinyApp_Proof_of_Concept/POC_Abundance_manipulated.csv"))
str(POC_Abundance)
...
POC_AO<-read.csv(here::here("Data/Data_SHinyApp_Proof_of_Concept/POC_AreaOccupied_manipulated.csv"))
str(POC_AO)
...
POC_AWD<-read.csv(here::here("Data/Data_SHinyApp_Proof_of_Concept/POC_AWD_manipulated.csv"))
str(POC_AWD)
...
POC_COG<-read.csv(here::here("Data/Data_SHinyApp_Proof_of_Concept/POC_COG_manipulated.csv"))
str(POC_COG)
...
POC_DtoB<-read.csv(here::here("Data/Data_SHinyApp_Proof_of_Concept/POC_DtoB_manipulated.csv"))
str(POC_DtoB)
